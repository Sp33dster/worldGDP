package pl.speedster.worldgdp.test.controller.api;
...
import pl.speedster.worldgdp.AppConfiguration;
import pl.speedster.worldgdp.dao.CountryLanguageDAO;
...
public class CountryLanguageAPIControllerTest {
    ...
    public void testAddLanguage() throws Exception{
        ...
        List<CountryLanguage> langs = countryLanguageDAO.getLanguages(countryCode,1);
        CountryLanguage first = langs.get(0);
        assertThat(first.getLanguage()).isEqualTo("TEST");
        countryLanguageDAO.deleteLanguage(countryCode, first.getLanguage());
    }
    ...
    public void testAddLanguage_DuplicateLang() throws Exception{
        ...
        countryLanguageDAO.deleteLanguage(countryCode, cl.getLanguage());
    }
